...
if(isset($_POST['btnSubmit'])){
    ...
    $headers .= "Reply-To: Fred <thisIsNot@AnEmail.com> \n";
    ...
    $body = 'Character: ' . $char . ' Problem: ' . $prob . ' Message: ' . $msg;
    
    $ret = mail('broken@gasr.com', 'Houston, we have a problem.', $body, $headers);
